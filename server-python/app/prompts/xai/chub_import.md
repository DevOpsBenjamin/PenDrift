...
**CRITICAL FOR xAI/GROK:** You MUST include the `thinking` field inside the JSON output itself. DO NOT rely on your internal reasoning field. Your response must be a single JSON object starting with the `thinking` key.
